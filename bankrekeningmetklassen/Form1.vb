Public Class Form1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        ListBox1.Items.Add("Rekening 1 bevat " & geld.GeefAantalrekening(1))
        ListBox1.Items.Add("Rekening 2 bevat " & geld.GeefAantalrekening(2))
        ListBox1.Items.Add("Rekening 3 bevat " & geld.GeefAantalrekening(3))
    End Sub
